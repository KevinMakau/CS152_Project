...
#line 208 "y.tab.h" // lalr1.cc:377
  ...
  public:
    ...
    union union_type
    {
      ...
      // var_loop
      // expression_loop
      char dummy5[sizeof(std::vector<ExprStruct>)];
  ...
  basic_symbol (typename Base::kind_type t, const ExprStruct v, const location_type& l);

  basic_symbol (typename Base::kind_type t, const StatementStruct v, const location_type& l);
  ...
  template <typename Base>
  parser::basic_symbol<Base>::basic_symbol (typename Base::kind_type t, const ExprStruct v, const location_type& l)
    : Base (t)
    , value (v)
    , location (l)
  {}
  ...
  template <typename Base>
  parser::basic_symbol<Base>::basic_symbol (typename Base::kind_type t, const StatementStruct v, const location_type& l)
    : Base (t)
    , value (v)
    , location (l)
  {}
  ...
  template <typename Base>
  parser::basic_symbol<Base>::basic_symbol (typename Base::kind_type t, const std::vector<ExprStruct> v, const location_type& l)
    : Base (t)
    , value (v)
    , location (l)
  {}
  ...
  template <typename Base>
  parser::basic_symbol<Base>::basic_symbol (typename Base::kind_type t, const std::vector<StatementStruct> v, const location_type& l)
    : Base (t)
    , value (v)
    , location (l)
  {}
